#!/usr/bin/env python3
"""Build docs/part2/08-memory-wall-and-roofline-model.md from chapter08_template.md
...
TEMPLATE = BASE / "chapter08_template.md"
OUTPUT = BASE / "docs/part2/08-memory-wall-and-roofline-model.md"

FILES = {
    1: "01_roofline_and_ridge_point.cpp",
    2: "02_kernel_arithmetic_intensity.cpp",
    3: "03_prefill_vs_decode.cpp",
    4: "04_continuous_batching.cpp",
    5: "05_full_layer_roofline_profile.cpp",
}
OUT_FILES = {
