#!/usr/bin/env python3
"""Build docs/part2/10-threading-and-concurrency.md from chapter10_template.md
...
TEMPLATE = BASE / "chapter10_template.md"
OUTPUT = BASE / "docs/part2/10-threading-and-concurrency.md"

FILES = {
    1: "01_latency_budget_and_amdahls_law.cpp",
    2: "02_atomics_mutexes_and_synchronization.cpp",
    3: "03_barrier_thread_pool_gemv.cpp",
    4: "04_false_sharing_and_cache_line_layout.cpp",
    5: "05_work_stealing_scheduler.cpp",
}
OUT_FILES = {
