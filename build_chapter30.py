#!/usr/bin/env python3
"""Build docs/part6/30-mathematical-foundations.md from chapter30_template.md
...
TEMPLATE = BASE / "chapter30_template.md"
OUTPUT = BASE / "docs/part6/30-mathematical-foundations.md"
