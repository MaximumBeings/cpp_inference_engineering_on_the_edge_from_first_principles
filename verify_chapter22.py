#!/usr/bin/env python3
"""Verify docs/part5/22-security-accessibility-art.md.

Every section in this chapter (22.1 through 22.3) is pure, deterministic
...
sandbox, so this script recompiles and reruns all three sections without
any documented reduced-verification exception. All three sections compile
...
MD_PATH = BASE / "docs/part5/22-security-accessibility-art.md"

EXPECTED_H1 = "# Chapter 22: Security Surveillance, Accessibility Compliance, and Art Authentication"
EXPECTED_H2 = [
...
def main() -> int:
    ...
    for idx, fname in FILES.items():
        src = BASE / fname
        binp = BASE / f"_verify_ch22_{idx:02d}_bin"
