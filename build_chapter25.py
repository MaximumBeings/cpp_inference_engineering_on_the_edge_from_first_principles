#!/usr/bin/env python3
"""Build docs/part5/25-body-worn-and-personal-cameras.md from
chapter25_template.md by substituting @@CODEn@@ with each section's locked
...
TEMPLATE = BASE / "chapter25_template.md"
OUTPUT = BASE / "docs/part5/25-body-worn-and-personal-cameras.md"
