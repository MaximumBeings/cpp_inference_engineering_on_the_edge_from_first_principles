#!/usr/bin/env python3
"""Verify docs/part5/23-trust-authenticity-point-of-sale.md.

Every section in this chapter (23.1 through 23.4) is pure, deterministic
...
with plain flags -- no section in this chapter touches Chapter 18's vision-
encoder machinery, so none needs -ffp-contract=off or the vendored mdspan
include path.
"""
import re
import subprocess
...
MD_PATH = BASE / "docs/part5/23-trust-authenticity-point-of-sale.md"

EXPECTED_H1 = "# Chapter 23: Trust and Authenticity at the Point of Sale: Counterfeits, Reconciliation, Expense Audits, and Luxury Goods"
EXPECTED_H2 = [
...
FILES = {
    1: "01_counterfeit_screening_and_seller_trust.cpp",
    2: "02_receipt_transaction_reconciliation.cpp",
    3: "03_expense_report_policy_enforcement.cpp",
    4: "04_luxury_goods_authentication_engine.cpp",
}
OUT_FILES = {
    1: "01_counterfeit_screening_and_seller_trust.out.txt",
    2: "02_receipt_transaction_reconciliation.out.txt",
    3: "03_expense_report_policy_enforcement.out.txt",
    4: "04_luxury_goods_authentication_engine.out.txt",
}
...
def main() -> int:
    ...
    for idx, fname in FILES.items():
        src = BASE / fname
        binp = BASE / f"_verify_ch23_{idx:02d}_bin"
