#!/usr/bin/env python3
"""Verify docs/part5/29-on-device-aml-transaction-monitoring.md.
...
MD_PATH = BASE / "docs/part5/29-on-device-aml-transaction-monitoring.md"

EXPECTED_H1 = "# Chapter 29: On-Device AML Transaction Anomaly Monitoring at ATMs and POS Terminals"
EXPECTED_H2 = [
...
def main() -> int:
    ...
    for idx, fname in FILES.items():
        src = BASE / fname
        binp = BASE / f"_verify_ch29_{idx:02d}_bin"
