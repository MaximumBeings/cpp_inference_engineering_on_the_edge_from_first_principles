#!/usr/bin/env python3
"""Verify docs/part5/28-insurance-claims-photo-assessment-fraud-flagging.md.
...
MD_PATH = BASE / "docs/part5/28-insurance-claims-photo-assessment-fraud-flagging.md"

EXPECTED_H1 = "# Chapter 28: Insurance Claims Photo Assessment with Fraud Flagging"
EXPECTED_H2 = [
