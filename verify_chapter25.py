#!/usr/bin/env python3
"""Verify docs/part5/25-body-worn-and-personal-cameras.md.
...
determinism check -- no reduced-verification exception like Section
24.2's real OpenCV dependency.
"""
import re
import subprocess
...
MD_PATH = BASE / "docs/part5/25-body-worn-and-personal-cameras.md"

EXPECTED_H1 = "# Chapter 25: Body-Worn and Personal Cameras: Evidence Documentation and Health Tracking"
EXPECTED_H2 = [
...
FILES = {
    1: "01_bodycam_frame_sampling_and_scene_tagging.cpp",
    2: "02_incident_report_drafting_and_chain_of_custody.cpp",
    3: "03_exercise_form_analysis_and_rep_counting.cpp",
    4: "04_camera_based_nutrition_tracking.cpp",
}
OUT_FILES = {
    1: "01_bodycam_frame_sampling_and_scene_tagging.out.txt",
    2: "02_incident_report_drafting_and_chain_of_custody.out.txt",
    3: "03_exercise_form_analysis_and_rep_counting.out.txt",
    4: "04_camera_based_nutrition_tracking.out.txt",
}
...
def main() -> int:
    ...
    for idx, fname in FILES.items():
        src = BASE / fname
        binp = BASE / f"_verify_ch25_{idx:02d}_bin"
